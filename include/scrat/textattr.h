...
namespace scrat
{
	...
	public:
        ...
        static std::string ansi(textattr::pair color_pair_);
    ...
    template<textattr::format> class SCRAT_API attr : public textattr {};

    template<> class SCRAT_API attr<textattr::format::ansi256> : public textattr
    {
    public:
    ...
    struct SCRAT_API attribute_list
    {
        std::string id;
